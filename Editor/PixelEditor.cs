...
public class PixelEditor : EditorWindow
{
    ...
    private MouseCursorController _workspaceCursor = null;
    ...
    public static bool OnOpenAsset(int instanceID, int line)
    {
        if (Selection.activeObject as PixelArt)
        {
            ...
            Texture icon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/PE/Editor/Editor Resources/Icons/PixelArtEditor.psd");
            ...
            var window = EditorWindow.GetWindow<PixelEditor>();
            window.titleContent = titleContent;
    ...
    public void OnEnable()
    {
        ...
        _cursorDraw = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/PE/Editor/Editor Resources/Cursors/Pencil.psd");
        _cursorEyeDropper = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/PE/Editor/Editor Resources/Cursors/EyeDropper.psd");
        ...
        root.styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/PE/Editor/PixelEditor.uss"));
        ...
        _workspace.RegisterCallback<KeyDownEvent>(OnWorkspaceKeyDown);
        ...
        _workspaceCursor = new MouseCursorController();
    ...
    private void UpdateCursor(Vector2 localPosition, bool reset=false)
    {
        ...
        if(_tool == ToolType.EyeDropper)
            _workspaceCursor.SetCustomCursor(_cursorEyeDropper, new Vector2(0, 31));
        else if (IsDrawing || _layer.IsMouseOver(localPosition))
            _workspaceCursor.SetCustomCursor(_cursorDraw, new Vector2(0, 31));
        else
